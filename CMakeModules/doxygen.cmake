configure_file("ltn.doxygen.in" "${CMAKE_BINARY_DIR}/ltn.doxygen")
...
if(NOT DOXYGEN_FOUND)
  ...
  set(DOXY_LTN_VERSION "${VERSION_FULL}" CACHE INTERNAL "Version string used in PROJECT_NUMBER.")
  ...
  if(BUILD_DOXYGEN)
    ...
    add_custom_target(contract_documentation ALL
      COMMAND "${DOXYGEN_EXECUTABLE}" "${CMAKE_BINARY_DIR}/ltn.doxygen"
