...
FC_REFLECT(ltnio::chain::permission_level_weight, (permission)(weight) )
FC_REFLECT(ltnio::chain::key_weight, (key)(weight) )
FC_REFLECT(ltnio::chain::wait_weight, (wait_sec)(weight) )
FC_REFLECT(ltnio::chain::authority, (threshold)(keys)(accounts)(waits) )
FC_REFLECT(ltnio::chain::shared_authority, (threshold)(keys)(accounts)(waits) )
