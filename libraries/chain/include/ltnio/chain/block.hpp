...
FC_REFLECT_ENUM( ltnio::chain::transaction_receipt::status_enum,
                 (executed)(soft_fail)(hard_fail)(delayed)(expired) )

FC_REFLECT(ltnio::chain::transaction_receipt_header, (status)(cpu_usage_us)(net_usage_words) )
FC_REFLECT_DERIVED(ltnio::chain::transaction_receipt, (ltnio::chain::transaction_receipt_header), (trx) )
FC_REFLECT_DERIVED(ltnio::chain::signed_block, (ltnio::chain::signed_block_header), (transactions)(block_extensions) )
