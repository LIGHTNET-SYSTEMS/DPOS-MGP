...
FC_REFLECT( ltnio::chain::detail::block_header_state_common,
            (block_num)
...
FC_REFLECT( ltnio::chain::detail::schedule_info,
            (schedule_lib_num)
            (schedule_hash)
            (schedule)
)

FC_REFLECT_DERIVED(  ltnio::chain::block_header_state, (ltnio::chain::detail::block_header_state_common),
                     (id)
                     (header)
                     (pending_schedule)
