...
CHAINBASE_SET_INDEX_TYPE(ltnio::chain::code_object, ltnio::chain::code_index)

FC_REFLECT(ltnio::chain::code_object, (code_hash)(code)(code_ref_count)(first_block_used)(vm_type)(vm_version))
