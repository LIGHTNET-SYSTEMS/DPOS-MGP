...
#include <ltnio/chain/multi_index_includes.hpp>
...
CHAINBASE_SET_INDEX_TYPE(ltnio::chain::table_id_object, ltnio::chain::table_id_multi_index)
CHAINBASE_SET_INDEX_TYPE(ltnio::chain::key_value_object, ltnio::chain::key_value_index)

CHAINBASE_SET_INDEX_TYPE(ltnio::chain::index64_object, ltnio::chain::index64_index)
CHAINBASE_SET_INDEX_TYPE(ltnio::chain::index128_object, ltnio::chain::index128_index)
CHAINBASE_SET_INDEX_TYPE(ltnio::chain::index256_object, ltnio::chain::index256_index)
CHAINBASE_SET_INDEX_TYPE(ltnio::chain::index_double_object, ltnio::chain::index_double_index)
CHAINBASE_SET_INDEX_TYPE(ltnio::chain::index_long_double_object, ltnio::chain::index_long_double_index)

FC_REFLECT(ltnio::chain::table_id_object, (code)(scope)(table)(payer)(count) )
FC_REFLECT(ltnio::chain::key_value_object, (primary_key)(payer)(value) )

#define REFLECT_SECONDARY(type)\
  FC_REFLECT(type, (primary_key)(payer)(secondary_key) )

REFLECT_SECONDARY(ltnio::chain::index64_object)
REFLECT_SECONDARY(ltnio::chain::index128_object)
REFLECT_SECONDARY(ltnio::chain::index256_object)
REFLECT_SECONDARY(ltnio::chain::index_double_object)
REFLECT_SECONDARY(ltnio::chain::index_long_double_object)
