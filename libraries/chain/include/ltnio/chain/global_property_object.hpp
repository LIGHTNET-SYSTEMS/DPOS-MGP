...
#include <ltnio/chain/incremental_merkle.hpp>
...
CHAINBASE_SET_INDEX_TYPE(ltnio::chain::global_property_object, ltnio::chain::global_property_multi_index)
CHAINBASE_SET_INDEX_TYPE(ltnio::chain::dynamic_global_property_object,
                         ltnio::chain::dynamic_global_property_multi_index)

FC_REFLECT(ltnio::chain::global_property_object,
            (proposed_schedule_block_num)(proposed_schedule)(configuration)
          )

FC_REFLECT(ltnio::chain::dynamic_global_property_object,
