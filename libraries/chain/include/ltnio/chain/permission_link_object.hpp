...
CHAINBASE_SET_INDEX_TYPE(ltnio::chain::permission_link_object, ltnio::chain::permission_link_index)

FC_REFLECT(ltnio::chain::permission_link_object, (account)(code)(message_type)(required_permission))
