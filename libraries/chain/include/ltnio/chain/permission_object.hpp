...
CHAINBASE_SET_INDEX_TYPE(ltnio::chain::permission_object, ltnio::chain::permission_index)
CHAINBASE_SET_INDEX_TYPE(ltnio::chain::permission_usage_object, ltnio::chain::permission_usage_index)

FC_REFLECT(ltnio::chain::permission_object, (usage_id)(parent)(owner)(name)(last_updated)(auth))
FC_REFLECT(ltnio::chain::snapshot_permission_object, (parent)(owner)(name)(last_updated)(last_used)(auth))

FC_REFLECT(ltnio::chain::permission_usage_object, (last_used))
