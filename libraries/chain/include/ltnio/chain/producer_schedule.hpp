...
FC_REFLECT( ltnio::chain::producer_key, (producer_name)(block_signing_key) )
FC_REFLECT( ltnio::chain::producer_schedule_type, (version)(producers) )
FC_REFLECT( ltnio::chain::shared_producer_schedule_type, (version)(producers) )
