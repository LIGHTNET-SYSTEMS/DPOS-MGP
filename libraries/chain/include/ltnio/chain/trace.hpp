...
FC_REFLECT( ltnio::chain::account_delta,
            (account)(delta) )

FC_REFLECT( ltnio::chain::action_trace,
...
FC_REFLECT( ltnio::chain::transaction_trace, (id)(block_num)(block_time)(producer_block_id)
