...
CHAINBASE_SET_INDEX_TYPE(ltnio::chain::transaction_object, ltnio::chain::transaction_multi_index)

FC_REFLECT(ltnio::chain::transaction_object, (expiration)(trx_id))
