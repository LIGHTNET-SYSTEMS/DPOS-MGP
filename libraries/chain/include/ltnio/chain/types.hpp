...
namespace ltnio { namespace chain {
   ...
   /**
    *  Important notes on using chainbase objects in LTNIO code:
    *
    ...
    *  others are due to requirements to ensure determinism in the LTNIO chain library.
    *
