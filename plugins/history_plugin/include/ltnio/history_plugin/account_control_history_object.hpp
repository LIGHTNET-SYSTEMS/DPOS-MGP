...
CHAINBASE_SET_INDEX_TYPE( ltnio::account_control_history_object, ltnio::account_control_history_multi_index )

FC_REFLECT( ltnio::account_control_history_object, (controlled_account)(controlled_permission)(controlling_account) )
