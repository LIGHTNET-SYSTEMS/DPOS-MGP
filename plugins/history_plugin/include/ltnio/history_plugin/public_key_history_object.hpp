...
CHAINBASE_SET_INDEX_TYPE( ltnio::public_key_history_object, ltnio::public_key_history_multi_index )

FC_REFLECT( ltnio::public_key_history_object, (public_key)(name)(permission) )
