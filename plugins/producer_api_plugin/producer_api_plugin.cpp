 ...
 */
#include <ltnio/producer_api_plugin/producer_api_plugin.hpp>
...
FC_REFLECT(ltnio::detail::producer_api_plugin_response, (result));
...
#define INVOKE_V_R(api_handle, call_name, in_param) \
     ...
     ltnio::detail::producer_api_plugin_response result{"ok"};
