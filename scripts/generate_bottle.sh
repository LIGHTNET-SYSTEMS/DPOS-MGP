...
mkdir -p ${PROJECT}/${VERSION}/opt/ltnio/lib/cmake
...
echo "class LTNIO < Formula

   homepage \"${URL}\"
   revision 0
   url \"https://github.com/ltnio/ltn/archive/v${VERSION}.tar.gz\"
   version \"${VERSION}\"
   ...
   bottle do
      root_url \"https://github.com/ltnio/ltn/releases/download/v${VERSION}\"
