...
read -d '' genesis << EOF
{
  ...
  "initial_key": "LTN6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV",
...
plugin = ltnio::net_plugin
plugin = ltnio::history_api_plugin
http-server-address = 127.0.0.1:8888
blocks-dir = blocks
p2p-listen-endpoint = 0.0.0.0:9876
allowed-connection = any
private-key = ['LTN6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV','5KQwrPbwdL6PhXujxW37FSSQZ1JiwsST4cqQzDeyXtP79zkvFD3']
...
programs/ltnio-launcher/ltnio-launcher -p $pnodes -n $total_nodes --nogen -d $delay
...
b5idbios=`./programs/clltn/clltn -u http://localhost:8888 get block 5 | grep "^ *\"id\""`
b5id00=`./programs/clltn/clltn -u http://localhost:8889 get block 5 | grep "^ *\"id\""`
b5id01=`./programs/clltn/clltn -u http://localhost:8890 get block 5 | grep "^ *\"id\""`
