...
class Utils:
    ...
    LtnClientPath="programs/clltn/clltn"
    MiscLtnClientArgs="--no-auto-kltnd"

    LtnWalletName="kltnd"
    LtnWalletPath="programs/kltnd/"+ LtnWalletName

    LtnServerName="nodltn"
    LtnServerPath="programs/nodltn/"+ LtnServerName

    LtnLauncherPath="programs/ltnio-launcher/ltnio-launcher"
    MongoPath="mongo"
    ShuttingDown=False
    CheckOutputDeque=deque(maxlen=10)

    LtnBlockLogPath="programs/ltnio-blocklog/ltnio-blocklog"
    ...
    def getBlockLog(blockLogLocation, silentErrors=False, exitOnError=False):
        ...
        cmd="%s --blocks-dir %s --as-json-array" % (Utils.LtnBlockLogPath, blockLogLocation)
